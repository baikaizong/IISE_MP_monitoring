...
program main
    ...
    open(unit=12, file="./data/T_IC.txt")
    do i = 1, all_size, 1
      read(11,*), allsample(:,i)
     end do
     !print*,allsample
    close(11)
    open(unit=10, file="./data/T_statistic.txt")
    ...
    do while ( i>leave_size )
        ...
        do j = 1, i, 1		
		    print*,j
            CALL T_Estimation(i,sample,j,miu_0,Cov_0,MMTest)
			print*,"**********************"	
			print*,MMTest
    ...
    do k = 1, on_size, 1 
        ...
        call T_square(lambdaewma,n,testsample,miu_0,miu_IC,Inverse_Cov_exp,globaltest) 
        print*,globaltest
        write(10,*),globaltest     
        j=j+n
    end do

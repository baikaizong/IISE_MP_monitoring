...
program main
    ...
    open(10,file="./results/Tsquare_Poi.txt")
    ...
    write(10,*),"Limit is",Limit
    write(10,*),"IC_arl is",arl  
    call Tsquare_Poi(lambdaewma,0.05,0.20,limit,lambda_0,miu_exp,Cov_exp) 
    ...
    write(10,*),"Limit is",Limit
    write(10,*),"IC_arl is",arl
    call Tsquare_Poi(lambdaewma,0.04,0.20,limit,lambda_0,miu_exp,Cov_exp) 
    ...
    write(10,*),"Limit is",Limit
    write(10,*),"IC_arl is",arl
    call Tsquare_Poi(lambdaewma,0.02,0.20,limit,lambda_0,miu_exp,Cov_exp) 

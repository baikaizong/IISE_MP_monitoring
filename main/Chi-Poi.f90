module constants
    implicit none
    integer, parameter::dim=3,simu_IC=10000,simu_OC=2000,n=20,window_size=50,ewma=50,IC_sample_size=20000
...
program main
    ...
    open(10,file="./results/Pei_Poi.txt")
    ...
    call Pei_Poi(lambdaewma,0.05,0.20,limit,c_parameter,midian,ICpr_cell) 
    ...
    write(10,*),"IC_arl is",arl
	write(10,*),"IC_std is",std 
    call Pei_Poi(lambdaewma,0.04,0.20,limit,c_parameter,midian,ICpr_cell) 
    ...
    write(10,*),"IC_arl is",arl
	write(10,*),"IC_std is",std 
    call Pei_Poi(lambdaewma,0.02,0.20,limit,c_parameter,midian,ICpr_cell) 

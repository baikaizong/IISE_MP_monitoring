...
program main
    ...
    real c_parameter
    open(10,file="./results/D_Poi.txt")
    ...
    call D_Poi(lambdaewma,0.05,0.20,limit,lambda_0,CL) 
    ...
    write(10,*),"Limit is",Limit
    write(10,*),"IC_arl is",arl
    call D_Poi(lambdaewma,0.04,0.20,limit,lambda_0,CL) 
    ...
    write(10,*),"Limit is",Limit
    write(10,*),"IC_arl is",arl
    call D_Poi(lambdaewma,0.02,0.20,limit,lambda_0,CL) 
